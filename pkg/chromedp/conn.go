...
import (
	...
	"github.com/cdvelop/devbrowser/pkg/easyjson/jlexer"
	"github.com/cdvelop/devbrowser/pkg/easyjson/jwriter"
	"github.com/cdvelop/devbrowser/pkg/ws"
	"github.com/cdvelop/devbrowser/pkg/ws/wsutil"

	"github.com/cdvelop/devbrowser/pkg/cdproto"
)
...
func DialContext(ctx context.Context, urlstr string, opts ...DialOption) (*Conn, error) {
	...
	c := &Conn{
		...
		// github.com/cdvelop/devbrowser/pkg/ws will grow the buffer size if needed.
...
func (c *Conn) Write(_ context.Context, msg *cdproto.Message) error {
	...
	// Luckily, now github.com/cdvelop/devbrowser/pkg/ws will grow the buffer if needed.
