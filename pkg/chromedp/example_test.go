...
import (
	...
	"github.com/cdvelop/devbrowser/pkg/chromedp"
	"github.com/cdvelop/devbrowser/pkg/chromedp/device"
...
func ExamplePrintToPDF() {
	...
	var buf []byte
	if err := chromedp.Run(ctx,
		chromedp.Navigate(`https://pkg.go.dev/github.com/cdvelop/devbrowser/pkg/chromedp`),
